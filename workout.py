...
class Workout():
    ...
    def bro_split(self, level):
        bro_split = {
            'num days': 4,
            'days': {
                'Chest/Triceps': (self.get_chest(level, 'bro') + self.get_triceps(level, 'bro')),
                'Back/Biceps': (self.get_back(level, 'bro') + self.get_biceps(level, 'bro')),
    ...
    def full_body(self, level):
        full_body = {
            'num days': [2, 3],
            'days': {
                'Full Body 1': (self.get_chest(level, 'full') + self.get_back(level, 'full') + self.get_legs(level, 'full') + self.get_triceps(level, 'full') + self.get_biceps(level, 'full')),
                'Full Body 2': (self.get_chest(level, 'full') + self.get_back(level, 'full') + self.get_legs(level, 'full') + self.get_triceps(level, 'full') + self.get_biceps(level, 'full')),
                'Full Body 3': (self.get_chest(level, 'full') + self.get_back(level, 'full') + self.get_legs(level, 'full') + self.get_triceps(level, 'full') + self.get_biceps(level, 'full')),
            },
        }
    ...
    def push_pull_legs(self, level):
        push_pull = {
            'num days': [3, 6],
            'days': {
                'Push 1': (self.get_chest(level, 'push/pull/legs') + self.get_shoulder(level, 'push/pull/legs') + self.get_triceps(level, 'push/pull/legs')),
                'Pull 1': (self.get_back(level, 'push/pull/legs') + self.get_biceps(level, 'push/pull/legs') + self.get_abs(level, 'push/pull/legs')),
                'Legs 1': (self.get_legs(level, 'push/pull/legs')),
                'Push 2': (self.get_chest(level, 'push/pull/legs') + self.get_shoulder(level, 'push/pull/legs') + self.get_triceps(level, 'push/pull/legs')),
                'Pull 2': (self.get_back(level, 'push/pull/legs') + self.get_biceps(level, 'push/pull/legs') + self.get_abs(level, 'push/pull/legs')),
    ...
    def upper_lower(self, level):
        upper_lower = {
            'num days': [2, 4, 6],
            'days': {
                'Upper 1': (self.get_chest(level, 'upper/lower') + self.get_back(level, 'upper/lower') + self.get_shoulder(level, 'upper/lower') + self.get_biceps(level, 'upper/lower') + self.get_triceps(level, 'upper/lower')),
                'Lower 1': (self.get_legs(level, 'upper/lower') + self.get_abs(level, 'upper/lower')),
                'Upper 2': (self.get_chest(level, 'upper/lower') + self.get_back(level, 'upper/lower') + self.get_shoulder(level, 'upper/lower') + self.get_biceps(level, 'upper/lower') + self.get_triceps(level, 'upper/lower')),
                'Lower 2': (self.get_legs(level, 'upper/lower') + self.get_abs(level, 'upper/lower')),
                'Upper 3': (self.get_chest(level, 'upper/lower') + self.get_back(level, 'upper/lower') + self.get_shoulder(level, 'upper/lower') + self.get_biceps(level, 'upper/lower') + self.get_triceps(level, 'upper/lower')),
                'Lower 3': (self.get_legs(level, 'upper/lower') + self.get_abs(level, 'upper/lower')),
            },
        }
