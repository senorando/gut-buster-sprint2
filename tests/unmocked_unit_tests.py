...
class Test(unittest.TestCase):
    ...
    def test_bmr_cal(self):
        ...
        result= calories_count.bmr_cal(data['weight'],data['height'],data['age'],data['gender'])
        print(result)
        expected={
            'weight': 24,
            'height': 52,
        ...
        result= calories_count.bmr_cal(data1['weight'],data1['height'],data1['age'],data1['gender'])
    ...
    def test_daily_Caloric_need(self):
        ...
        for test in data:
            result= calories_count.daily_caloric_need(test['bmr'],test['activityLevel'])
            print(result)
            expected=test
